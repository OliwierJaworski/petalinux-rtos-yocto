...
puts -nonewline "\033\[2JEnter the path to your external IP repository:"
flush stdout
set ip_repo_path [gets stdin]

if { $ip_repo_path ne "" } {
    set_property ip_repo_paths [list $ip_repo_path] [current_project]
    update_ip_catalog
    puts "Added IP repo: $ip_repo_path"
}
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {148.5000} \
  ...
  # Create instance: reset_ps7_0_100M, and set properties
  set reset_ps7_0_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 reset_ps7_0_100M ]
  ...
  connect_bd_net -net Net [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins reset_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins rst_clk_wiz_0_148M/slowest_sync_clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins v_tc_0/clk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_148M/dcm_locked]
  connect_bd_net -net one_dout [get_bd_pins one/dout] [get_bd_pins v_tc_0/clken]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clk_wiz_0_148M/ext_reset_in] [get_bd_pins reset_ps7_0_100M/ext_reset_in] [get_bd_pins clk_wiz_0/resetn]
  connect_bd_net -net reset_ps7_0_100M_peripheral_aresetn [get_bd_pins reset_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN]
  connect_bd_net -net rgb2dvi_0_TMDS_Clk_n [get_bd_pins rgb2dvi_0/TMDS_Clk_n] [get_bd_ports hdmi_tx_clk_n]
  connect_bd_net -net rgb2dvi_0_TMDS_Clk_p [get_bd_pins rgb2dvi_0/TMDS_Clk_p] [get_bd_ports hdmi_tx_clk_p]
  connect_bd_net -net rgb2dvi_0_TMDS_Data_n [get_bd_pins rgb2dvi_0/TMDS_Data_n] [get_bd_ports hdmi_tx_d_n]
  connect_bd_net -net rgb2dvi_0_TMDS_Data_p [get_bd_pins rgb2dvi_0/TMDS_Data_p] [get_bd_ports hdmi_tx_d_p]
  connect_bd_net -net rst_clk_wiz_0_148M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_148M/peripheral_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins v_tc_0/resetn]
